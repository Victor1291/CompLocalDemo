...
package com.shu.complocaldemo.sample
...
class LocalDateTimeSamples {
    ...
    fun parsing() {
        ...
        check(
            LocalDateTime.parse("2024-02-15T08:30:15.123456789") ==
                    LocalDate(2024, 2, 15).atTime(8, 30, 15, 123_456_789)
        )
        check(
            LocalDateTime.parse("2024-02-15T08:30") ==
        ...
        check(
            LocalDateTime.parse("2024-02-15 08:30:15,123", customFormat) ==
    ...
    fun customFormat() {
        ...
        check(
            customFormat.parse("2024-02-15 08:30:15,123") ==
                    LocalDate(2024, 2, 15).atTime(8, 30, 15, 123_000_000)
        )
    ...
    fun compareToSample() {
        ...
        check(
            date.atTime(hour = 8, minute = 30) < date.atTime(
                hour = 8,
                minute = 30,
                second = 0,
                nanosecond = 1
    ...
    fun toStringSample() {
        ...
        check(
            LocalDate(2024, 2, 15).atTime(16, 48, 15, 120_000_000)
                .toString() == "2024-02-15T16:48:15.120"
        )
    }
    ...
    fun formatting() {
        ...
        check(LocalDate(2024, 2, 15).atTime(16, 48).toString() == "2024-02-15T16:48")
        check(
            LocalDate(2024, 2, 15).atTime(16, 48)
                .format(LocalDateTime.Formats.ISO) == "2024-02-15T16:48:00"
        )
        val customFormat = LocalDateTime.Format {
            date(LocalDate.Formats.ISO)
            char(' ')
