...
class LocalDateSamples {
    ...
    fun fromAndToEpochDays() {
        ...
        //  check(randomDate.toEpochDays().toLong() == randomEpochDay)
    }
    ...
    fun day() {
        ...
        for (day in 1..30) {
            check(LocalDate(2024, Month.APRIL, day).dayOfMonth == day)
        }
    }
    ...
    fun toEpochDays() {
        ...
        check(LocalDate(2024, Month.APRIL, 16).toEpochDays().toLong() == 19829L)
        check(LocalDate(1970, Month.JANUARY, 1).toEpochDays().toLong() == 0L)
        check(LocalDate(1969, Month.DECEMBER, 25).toEpochDays().toLong() == -7L)
    }
    ...
    fun plusPeriod() {
        ...
        check(
            startDate + DatePeriod(years = 1, months = 2, days = 3) == LocalDate(
                2023,
                Month.JANUARY,
                2
            )
