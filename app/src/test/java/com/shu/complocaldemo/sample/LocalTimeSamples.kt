...
class LocalTimeSamples {
    ...
    fun toNanosecondOfDay() {
        ...
        check(
            LocalTime(
                ...
                1,
                1
            ).toNanosecondOfDay() == 3_600_000_000_000L + 60_000_000_000 + 1_000_000_000 + 1
        )
    }
    ...
    fun compareTo() {
        ...
        check(
            LocalTime(hour = 8, minute = 30) < LocalTime(
                hour = 8,
                minute = 30,
                second = 0,
                nanosecond = 1
    ...
    fun formatting() {
        ...
        val timeWithNonZeroSecondFraction =
            LocalTime(hour = 8, minute = 30, second = 0, nanosecond = 120000000)
    ...
    fun iso() {
        ...
        val timeWithNanoseconds =
            LocalTime(hour = 8, minute = 30, second = 15, nanosecond = 160_000_000)
