...
import com.shu.complocaldemo.doc_compose.animation.page.RowHeaderPage

object RowHeader : Screen {
    private fun readResolve(): Any = RowHeader

    @Composable
    override fun Content() {
        val navigator = LocalNavigator.currentOrThrow
        RowHeaderPage(goBack = { navigator.pop() })
    }
}
